...
#include <gapi/gmat.hpp>      // GMat
#include <gapi/gscalar.hpp>   // GScalar
#include <gapi/gframe.hpp>    // GFrame
#include <gapi/garray.hpp>    // GArray<T>
#include <gapi/gopaque.hpp>   // GOpaque<T>
