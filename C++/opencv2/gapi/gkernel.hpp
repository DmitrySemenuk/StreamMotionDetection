...
#include <gapi/gcommon.hpp> // CompileArgTag
#include <gapi/util/util.hpp> // Seq
#include <gapi/gcall.hpp>
#include <gapi/garg.hpp>      // GArg
#include <gapi/gmetaarg.hpp>  // GMetaArg
#include <gapi/gtype_traits.hpp> // GTypeTraits
#include <gapi/util/compiler_hints.hpp> //suppress_unused_warning
#include <gapi/gtransform.hpp>
