...
#include <gapi/own/mat.hpp>
#include <gapi/media.hpp>

#include <gapi/util/util.hpp>
#include <gapi/util/any.hpp>
#include <gapi/util/variant.hpp>
...
#include <gapi/gtype_traits.hpp>
#include <gapi/gmetaarg.hpp>
#include <gapi/streaming/source.hpp>
#include <gapi/rmat.hpp>
