...
#include <gapi/own/exports.hpp>
#include <gapi/opencv_includes.hpp>

#include <gapi/util/any.hpp>
#include <gapi/util/variant.hpp>
#include <gapi/util/throw.hpp>
#include <gapi/util/type_traits.hpp>
#include <gapi/own/assert.hpp>

#include <gapi/gcommon.hpp>  // OpaqueKind
#include <gapi/garray.hpp>  // TypeHintBase
